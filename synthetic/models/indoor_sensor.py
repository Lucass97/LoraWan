...
class IndoorSensor(BaseModel):
    ...
    #timestamp: datetime = Field(description="Timestamp of the sensor reading. This is the format: YYYY-MM-DD HH:MM:SS. The range is from 2023-01-01 06:00:00 to 2024-01-01 06:00:00.")
    #timestamp: datetime = Field(description="Timestamp of the sensor reading. This is the format: YYYY-MM-DDTHH:MM:SS")
    
    temperature: int = Field(description="Indoor temperature. The range is from -20 to 70.")
    ...
    barometricPressure: int = Field(description=" Barometric Pressure. The range is from 300 hPa to 1100 hPa.")